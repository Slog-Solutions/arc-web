...
import UnitEditor from './admin/pages/UnitEditor';
import SubUnitEditor from './admin/pages/SubUnitEditor';
        ...
        {isAdmin ? (
          <Routes location={location}>
            ...
            <Route element={<AdminGuard><AdminLayout /></AdminGuard>}>
              ...
              <Route path="/admin/unit/:unitKey" element={<UnitEditor />} />
              <Route path="/admin/unit/:unitKey/sub/:subUnitId" element={<SubUnitEditor />} />
            </Route>
          </Routes>
        ) : (
          /* Museum frontend routes */
          <>
