...
export default function AssamUnitsHero({
  title,
  subtitle,
  tagline,
  established,
  ...
  return (
    <>
      ...
      <div ref={ref} className={`relative flex w-full items-center justify-center ${compact ? 'h-[38vh] min-h-[260px] md:min-h-[340px]' : 'h-screen min-h-[500px] md:min-h-[650px]'}`}>
        <motion.div
