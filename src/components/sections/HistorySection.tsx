...
export default function HistorySection({
  ...
  return (
    <section id="history" className="relative py-20 museum-room-wall spotlight-glow overflow-hidden">
      ...
      <div className="museum-container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10" style={{ marginBottom: '5rem' }}>
          {highlights.map((h, i) => (
            <motion.div
              key={h.label}
              ...
              className="relative p-8 text-center bg-gradient-to-b from-[#1a2210] to-[#0a0d07] border border-[#3a2910] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.6),0_0_0_1px_rgba(212,160,23,0.08)]"
            >
              {/* Corner screws */}
              ...
              <div className="font-cinzel text-4xl md:text-5xl text-gold-gradient font-bold leading-none mb-3">{h.value}</div>
              <div className="h-px w-8 bg-yellow-700/40 mx-auto mb-3" />
        ...
        {heroImage && (
          <motion.div
            ...
            style={{ height: '560px', marginBottom: '7rem' }}
          >
        ...
        <div className="space-y-32" style={{ marginBottom: '7rem' }}>
        ...
        {/* ── Quote plaques ─────────────────────────────── */}
        <div className="space-y-8" style={{ marginBottom: '3rem' }}>
          {quotes.map((q, i) => (
            <motion.blockquote
              key={i}
        ...
        <div style={{ position: 'relative', borderRadius: '1.5rem', overflow: 'hidden', padding: '3rem 0' }}>
